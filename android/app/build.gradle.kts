...
android {
    ...
    defaultConfig {
        ...
        versionCode = providers.gradleProperty("flutter.versionCode").map(String::toInt).getOrElse(12)
        versionName = providers.gradleProperty("flutter.versionName").getOrElse("0.1.0")
    }
